    ...
    public partial class oinit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationOrigions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Areas_Resturants_ResturantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IncrementDuration = table.Column<double>(type: "float", nullable: false),
                    ResturantId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sittings_Resturants_ResturantId",
                        column: x => x.ResturantId,
                        principalTable: "Resturants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservationOrigionId = table.Column<int>(type: "int", nullable: false),
                    Start = table.Column<DateTime>(type: "datetime2", nullable: false),
                    End = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PersonId = table.Column<int>(type: "int", nullable: false),
                    Note = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AreaId = table.Column<int>(type: "int", nullable: true),
                    ReservationTablesId = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_ReservationOrigions_ReservationOrigionId",
                        column: x => x.ReservationOrigionId,
                        principalTable: "ReservationOrigions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Online Reservation", "Customer" },
                    { 2, "Staff Create a Reservation", "Staff" },
                    { 3, "Register as a Member", "Customer-Register as a Member" },
                    { 4, "Admin Creates a Reservation", "Admin" }
                });

            migrationBuilder.InsertData(
                table: "Resturants",
                columns: new[] { "Id", "Name" },
                values: new object[] { 1, "BeanScene" });
            ...
            migrationBuilder.InsertData(
                table: "Areas",
                columns: new[] { "Id", "Name", "ResturantId" },
                values: new object[,]
                {
                    { 1, "Main Dinning", 1 },
                    { 2, "Outside", 1 },
            ...
            migrationBuilder.InsertData(
                table: "Tables",
                columns: new[] { "Id", "AreaId", "Availability", "Name" },
                values: new object[,]
                {
                    { 1, 1, false, "M1" },
                    { 2, 1, false, "M2" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_ReservationOrigionId",
                table: "Reservations",
                column: "ReservationOrigionId");
